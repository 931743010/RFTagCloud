...
- (void)viewDidLoad {
    ...
    NSArray *words = @[@"北京",@"火影忍者",@"足球小子",@"超人",@"葫芦娃大战蜘蛛精",@"super man",@"welcome to china",@"上海",@"海贼王",@"会说话的汤姆猫",@"大头儿子小头爸爸",@"少林足球",@"妖精的尾巴",@"咸蛋超人",@"蜘蛛侠",@"葫芦娃"];
    
    RFTagCloudView *tagView = [[RFTagCloudView alloc] initWithFrame:CGRectMake(30, 100, 260, 300)];
